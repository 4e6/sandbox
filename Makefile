OPTS = --make
EXES = AcmIcpcTeam AlternatingCharacters AngryChildren FillingJars FillingJarsVect FindDigits GameOfThrones1 IsFibo LoveLetterMystery MaximizingXOR UtopianTree
